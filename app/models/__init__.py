...
from .db_events import (
    ...
    get_all_recipe_types,
    create_recipe_type,
    update_recipe_type_entry,
    delete_recipe_type,
    get_recipe_recipe_types,
    set_recipe_recipe_types,
    save_event_dates,
    get_event_dates,
...
db = SimpleNamespace(
    ...
    delete_recipe_language=delete_recipe_language,
    ...
    get_all_recipe_types=get_all_recipe_types,
    create_recipe_type=create_recipe_type,
    update_recipe_type_entry=update_recipe_type_entry,
    delete_recipe_type=delete_recipe_type,
    get_recipe_recipe_types=get_recipe_recipe_types,
    set_recipe_recipe_types=set_recipe_recipe_types,
